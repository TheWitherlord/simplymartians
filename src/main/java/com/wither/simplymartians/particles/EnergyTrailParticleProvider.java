...
public class EnergyTrailParticleProvider implements ParticleProvider<SimpleParticleType> {
    ...
    public EnergyTrailParticleProvider(SpriteSet spriteSet) {
    ...
    @Override
    public EnergyTrailParticle createParticle(SimpleParticleType type, ClientLevel level,
            double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
        // We don't use the type and speed, and pass in everything else. You may of course use them if needed.
        return new EnergyTrailParticle(level, x, y, z, zSpeed, spriteSet);
    ...
    public static void registerParticleProviders(RegisterParticleProvidersEvent event) {
        ...
        event.registerSpriteSet(ModParticleTypes.ENERGY_TRAIL.get(), EnergyTrailParticleProvider::new);
