...
public class PlasmashockParticle extends TextureSheetParticle  {
    ...
    public PlasmashockParticle(ClientLevel level, double x, double y, double z, double pXSpeed, double pYSpeed, double pZSpeed, SpriteSet spriteSet) {
        super(level, x, y, z);
