...
public class OvershockParticleProvider implements ParticleProvider<SimpleParticleType> {
    ...
    public OvershockParticleProvider(SpriteSet spriteSet) {
    ...
    @Override
    public OvershockParticle createParticle(SimpleParticleType type, ClientLevel level,
            double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
        // We don't use the type and speed, and pass in everything else. You may of course use them if needed.
        return new OvershockParticle(level, x, y, z, zSpeed, zSpeed, zSpeed, spriteSet);
    ...
    public static void registerParticleProviders(RegisterParticleProvidersEvent event) {
        ...
        event.registerSpriteSet(ModParticleTypes.OVERSHOCK.get(), OvershockParticleProvider::new);
