...
public class ZombieMartianBruteModel<T extends ZombieMartianBruteEntity> extends EntityModel<T> implements ArmedModel, HeadedModel {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			 ResourceLocation.fromNamespaceAndPath(SimplyMartians.MODID, "zombie_martian_brute"), "main");	
	...
	public ZombieMartianBruteModel(ModelPart root) {
