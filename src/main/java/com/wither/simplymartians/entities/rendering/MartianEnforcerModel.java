...
public class MartianEnforcerModel<T extends MartianEnforcerEntity> extends EntityModel<T> implements ArmedModel, HeadedModel{
		// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			 ResourceLocation.fromNamespaceAndPath(SimplyMartians.MODID, "martian_enforcer"), "main");	
	public static final ModelLayerLocation MARTIAN_FORCEFIELD = new ModelLayerLocation(
			 ResourceLocation.fromNamespaceAndPath(SimplyMartians.MODID, "martian_forcefield"), "main");	
	private final ModelPart head;
		...
		public MartianEnforcerModel(ModelPart root) {
		...
		public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
			 ...
			 this.right_leg.xRot = -1.5F * Mth.triangleWave(pLimbSwing, 13.0F) * pLimbSwingAmount;
		      ...
		      if (pEntity.getItemInHand(InteractionHand.MAIN_HAND).getItem() == InitItem.MOTTGUN.get()) {
