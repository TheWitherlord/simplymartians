...
public class MottLaserRenderer extends EntityRenderer< MottLaser> {
	public static final ResourceLocation ZAP = ResourceLocation.fromNamespaceAndPath(SimplyMartians.MODID, "textures/entity/mott_laser.png");
	private static final RenderType RENDER_TYPE = RenderType.entityTranslucentEmissive(ZAP);

	public MottLaserRenderer(EntityRendererProvider.Context manager) {
		super(manager);
	}

	@Override
	public ResourceLocation getTextureLocation(MottLaser entity) {
		return ZAP;
	}

	 protected int getBlockLightLevel(MottLaser p_114087_, BlockPos p_114088_) {
	      return 15;
	   }
	
	 public void render(MottLaser pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
	        pPoseStack.pushPose();
