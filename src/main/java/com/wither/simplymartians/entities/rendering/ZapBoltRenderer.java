...
public class ZapBoltRenderer extends EntityRenderer< ZapBolt> {
	...
	public ZapBoltRenderer(EntityRendererProvider.Context manager) {
		super(manager);
	}

	@Override
	public ResourceLocation getTextureLocation(ZapBolt entity) {
		return ZAP;
	}
	 ...
	 public void render(ZapBolt pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
	        pPoseStack.pushPose();
