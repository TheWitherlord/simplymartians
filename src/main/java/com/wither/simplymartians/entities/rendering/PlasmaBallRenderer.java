...
public class PlasmaBallRenderer extends EntityRenderer<PlasmaBall> {
   ...
   public PlasmaBallRenderer(EntityRendererProvider.Context p_173962_) {
      super(p_173962_);
   }

   protected int getBlockLightLevel(PlasmaBall p_114087_, BlockPos p_114088_) {
      return 15;
   }

   public void render(PlasmaBall pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
       pPoseStack.pushPose();
   ...
   public ResourceLocation getTextureLocation(PlasmaBall p_114078_) {
