...
public class MartianBoltRenderer extends EntityRenderer< MartianBolt> {
	public static final ResourceLocation ZAP = ResourceLocation.fromNamespaceAndPath(SimplyMartians.MODID, "textures/entity/zap_bolt.png");
	private static final RenderType RENDER_TYPE = RenderType.entityTranslucentEmissive(ZAP);

	public MartianBoltRenderer(EntityRendererProvider.Context manager) {
		super(manager);
	}

	@Override
	public ResourceLocation getTextureLocation(MartianBolt entity) {
		return ZAP;
	}

	 protected int getBlockLightLevel(MartianBolt p_114087_, BlockPos p_114088_) {
	      return 15;
	   }
	
	 public void render(MartianBolt pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
	        pPoseStack.pushPose();
