...
@OnlyIn(Dist.CLIENT)
public class BiggerPlasmaBallRenderer extends EntityRenderer<BigPlasmaBall> {
   private static final ResourceLocation PLASMA_LOCATION = ResourceLocation.fromNamespaceAndPath(SimplyMartians.MODID,"textures/entity/plasma_ball.png");
   private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(PLASMA_LOCATION);

   public BiggerPlasmaBallRenderer(EntityRendererProvider.Context p_173962_) {
      super(p_173962_);
   }

   protected int getBlockLightLevel(BigPlasmaBall p_114087_, BlockPos p_114088_) {
      return 15;
   }

   public void render(BigPlasmaBall pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
       pPoseStack.pushPose();
   ...
   public ResourceLocation getTextureLocation(BigPlasmaBall p_114078_) {
