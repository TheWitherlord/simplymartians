...
public class UFOBossEntity extends PathfinderMob implements RangedAttackMob {
    ...
    protected void registerGoals() {
	    this.goalSelector.addGoal(1, new MartianProbeSummoningGoal(this, 3)); // Add the summon goal
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes()
        		.add(Attributes.ATTACK_DAMAGE, 2.0).add(Attributes.MAX_HEALTH, 50.0).add(Attributes.ARMOR, 2.0).add(Attributes.FLYING_SPEED, 0.13F).add(Attributes.FOLLOW_RANGE, 32.0);
    }
