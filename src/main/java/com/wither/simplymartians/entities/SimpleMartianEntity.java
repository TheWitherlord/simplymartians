...
public class SimpleMartianEntity extends Monster implements RangedAttackMob {
	...
	private final MeleeAttackGoal meleeGoal = new MeleeAttackGoal(this, 1.2, false) {
		...
		public void stop() {
			super.stop();
			SimpleMartianEntity.this.setAggressive(false);
		}

		@Override
		public void start() {
			super.start();
			SimpleMartianEntity.this.setAggressive(true);
		}
	};

	public SimpleMartianEntity(EntityType<? extends SimpleMartianEntity> entityType, Level level) {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new SimpleMartianEntity.MartianOpenDoorGoal(this));
		this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, Zombie.class, true));
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, AbstractVillager.class, false));
		this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, IronGolem.class, true));
		this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, ZombieMartianEntity.class, true));
		this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, ZombieMartianBruteEntity.class, true));
	...
	private ItemStack createSpawnWeapon() {
		return (double) this.random.nextFloat() < 0.5 ? new ItemStack(InitItem.MARTIAN_ZAPPER.get())
				: new ItemStack(InitItem.VIBRAEDGE.get());
	}

	protected class MartianOpenDoorGoal extends OpenDoorGoal {
		public MartianOpenDoorGoal(SimpleMartianEntity snake) {
			super(snake, false);
		}

		@Override
		public boolean canUse() {
			return super.canUse() && SimpleMartianEntity.this.isAlive();
		}
