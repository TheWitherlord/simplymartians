...
public class MartianZapperItem extends BowItem {
	
	private static final int COOLDOWN = 20;

	public MartianZapperItem(final Item.Properties properties) {
		super(properties);
	}
		...
		return InteractionResultHolder.consume(heldItem);
		 ...
		 @Override
			public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
	            ...
	            tooltip.add(Component.translatable("tooltip.simplymartians.zapper.tooltip").withStyle(ChatFormatting.GRAY));
	            tooltip.add(Component.translatable("tooltip.simplymartians.zapper.ammo").withStyle(ChatFormatting.DARK_GREEN) );
